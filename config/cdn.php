...
return [
    ...
    'providers' => [
        ...
        'aws' => [
            ...
            's3' => [
                ...
                |--------------------------------------------------------------------------
                |
                | The version of the web service to use.
                ...
                */
                ...
                | then you need to specify each bucket and its directories.
                |
                ...
                */
                'buckets' => [
                    ...
                    env('CDN_ASSET_BUCKET', 'current-affair-cdn-prod') => '*',
                    // examples:
                ...
                |
                */
                'upload_folder' => env('CDN_ASSET_UPLOAD_FOLDER', ''),
                ...
                */
                ...
                |
                */
                'expires' => gmdate('D, d M Y H:i:s T', \Carbon\Carbon::parse('+5 years')->getTimestamp()),
    ...
    */
    'include' => [
        'directories' => ['public/build', 'public/images', 'public/js', 'public/css', 'public/vendor'],
        'extensions' => [],
        'patterns' => [],
    ],
    ...
    | to the CDN.
    |
    | 'hidden' is a boolean to exclude "hidden" directories and files (starting with a dot)
    |
    */
    'exclude' => [
        'directories' => [],
